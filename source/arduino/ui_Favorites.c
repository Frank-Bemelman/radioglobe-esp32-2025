...
void ui_Favorites_screen_init(void)
{
    ...
    lv_obj_set_style_img_recolor(ui_IconWifi, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_img_recolor(ui_IconMemory, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_img_recolor(ui_IconSdCard, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
