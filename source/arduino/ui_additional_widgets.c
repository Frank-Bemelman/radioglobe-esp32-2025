...
//  uic_MusicLibraryButton = ui_MusicLibraryButton;
  ...
  ui_PresetFlag1 = lv_img_create(ui_Favorites);
  lv_img_set_src(ui_PresetFlag1, &ui_img_xx_png);
  lv_obj_set_width(ui_PresetFlag1, LV_SIZE_CONTENT);   /// 1
  lv_obj_set_height(ui_PresetFlag1, LV_SIZE_CONTENT);    /// 1
  lv_obj_set_x(ui_PresetFlag1, 155);
  lv_obj_set_y(ui_PresetFlag1, -104);
  lv_obj_set_align(ui_PresetFlag1, LV_ALIGN_CENTER);
  lv_obj_add_flag(ui_PresetFlag1, LV_OBJ_FLAG_HIDDEN);   
  lv_obj_clear_flag(ui_PresetFlag1, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_GESTURE_BUBBLE |
                      LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLLABLE);     /// Flags
  lv_img_set_zoom(ui_PresetFlag1, 192);
  uic_PresetFlag1 = ui_PresetFlag1;

  ui_PresetFlag2 = lv_img_create(ui_Favorites);
  lv_img_set_src(ui_PresetFlag2, &ui_img_xx_png);
  lv_obj_set_width(ui_PresetFlag2, LV_SIZE_CONTENT);   /// 1
  lv_obj_set_height(ui_PresetFlag2, LV_SIZE_CONTENT);    /// 1
  lv_obj_set_x(ui_PresetFlag2, 155);
  lv_obj_set_y(ui_PresetFlag2, -35);
  lv_obj_set_align(ui_PresetFlag2, LV_ALIGN_CENTER);
  lv_obj_add_flag(ui_PresetFlag2, LV_OBJ_FLAG_HIDDEN);   
  lv_obj_clear_flag(ui_PresetFlag2, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_GESTURE_BUBBLE |
                      LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLLABLE);     /// Flags
  lv_img_set_zoom(ui_PresetFlag2, 192);
  uic_PresetFlag2 = ui_PresetFlag2;

  ui_PresetFlag3 = lv_img_create(ui_Favorites);
  lv_img_set_src(ui_PresetFlag3, &ui_img_xx_png);
  lv_obj_set_width(ui_PresetFlag3, LV_SIZE_CONTENT);   /// 1
  lv_obj_set_height(ui_PresetFlag3, LV_SIZE_CONTENT);    /// 1
  lv_obj_set_x(ui_PresetFlag3, 155);
  lv_obj_set_y(ui_PresetFlag3, 35);
  lv_obj_set_align(ui_PresetFlag3, LV_ALIGN_CENTER);
  lv_obj_add_flag(ui_PresetFlag3, LV_OBJ_FLAG_HIDDEN);   
  lv_obj_clear_flag(ui_PresetFlag3, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_GESTURE_BUBBLE |
                      LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLLABLE);     /// Flags
  lv_img_set_zoom(ui_PresetFlag3, 192);
  uic_PresetFlag3 = ui_PresetFlag3;

  ui_PresetFlag4 = lv_img_create(ui_Favorites);
  lv_img_set_src(ui_PresetFlag4, &ui_img_xx_png);
  lv_obj_set_width(ui_PresetFlag4, LV_SIZE_CONTENT);   /// 1
  lv_obj_set_height(ui_PresetFlag4, LV_SIZE_CONTENT);    /// 1
  lv_obj_set_x(ui_PresetFlag4, 155);
  lv_obj_set_y(ui_PresetFlag4, 104);
  lv_obj_set_align(ui_PresetFlag4, LV_ALIGN_CENTER);
  lv_obj_add_flag(ui_PresetFlag4, LV_OBJ_FLAG_HIDDEN);   
  lv_obj_clear_flag(ui_PresetFlag4, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_GESTURE_BUBBLE |
                      LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLLABLE);     /// Flags
  lv_img_set_zoom(ui_PresetFlag4, 192);
  uic_PresetFlag4 = ui_PresetFlag4;
