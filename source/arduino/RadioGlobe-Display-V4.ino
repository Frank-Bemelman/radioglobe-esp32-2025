...
{ char content[256];
...

  {
    ...
    { PrevGlobalTicker1S = GlobalTicker1S;
      newbatteryvoltage = ((analogReadMilliVolts(BAT_ADC_PIN) * 3) + 50) / 10; // read voltage in tenths of volts times 3 because of voltage divider 
    ...
    { if(screen == ui_ClockScreen) // we are on clock screen
      ...
      { strcpy(OldClockFlagCountryCode, ClockFlagCountryCode);
        ...
        //if(screen == ui_Power)
        SetFlag(ClockFlagCountryCode,0);
