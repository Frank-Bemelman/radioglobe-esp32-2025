...
// ESP32_VS105_Stream by Cellie, files placed in arduino sketch folder
...
//  digitalWrite(VS1053_DCS, HIGH); 
  ...
  AutoConnectSetup(); // also prepares HostName from eeprom settings that hold globe serial number
...
//  delay(1000);
  ...
  if(GlobeSettings.globe_sd_gb)// !=0 && psramFound())
