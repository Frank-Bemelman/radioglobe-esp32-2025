...
//  _server -> on("/file", HTTP_GET, [ & ](AsyncWebServerRequest * request) {
  _server -> on("/", HTTP_GET, [ & ](AsyncWebServerRequest * request) {
    ...
    // FB changed to use sizeof()
  //  AsyncWebServerResponse * response = request -> beginResponse(200, "text/html", SecData, sizeof(SecData));
  ...
  //  request -> send(response);
    ...
    AsyncWebServerResponse * response = request -> beginResponse(200, "text/html", radioglobe_html_page, sizeof(radioglobe_html_page));
    request -> send(response); 
