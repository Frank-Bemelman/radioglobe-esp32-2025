...
{ WiFiClientSecure client;
  ...
  //Serial.println("MFree Heap at Start  GetOpenWeatherData()" + String(ESP.getFreeHeap()));   
  ...
  https.end();
  client.stop(); // stop insecure client
  Serial.printf("GetOpenWeatherData fetch took %ldms\n", (millis()-startMs));  
}
...
{ WiFiClientSecure client;  
  ...
  // Serial.println(url);
  Serial.print("Free Heap before flightdata: ");
  Serial.println(ESP.getFreeHeap());
  size_t largest_block = heap_caps_get_largest_free_block(MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT);
  printf("Largest internal free block after flightdata: %u bytes\n", largest_block);
  ...
  https.end();
  client.stop(); 
  Serial.print("Free Heap after flightdata: ");
  Serial.println(ESP.getFreeHeap());
  largest_block = heap_caps_get_largest_free_block(MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT);
  printf("Largest internal free block after flightdata: %u bytes\n", largest_block);
