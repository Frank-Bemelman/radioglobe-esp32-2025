...
void ui_event_WorldMap(lv_event_t * e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
...
void ui_DatabaseScreen_screen_init(void)
{
    ...
    ui_object_set_themeable_style_property(ui_RebuildDatabase, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_SHADOW_COLOR,
                                           _ui_theme_color_red);
    ui_object_set_themeable_style_property(ui_RebuildDatabase, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_SHADOW_OPA,
                                           _ui_theme_alpha_red);
    lv_obj_set_style_shadow_width(ui_RebuildDatabase, 5, LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_shadow_spread(ui_RebuildDatabase, 5, LV_PART_MAIN | LV_STATE_PRESSED);
    ...
    lv_obj_set_style_text_font(ui_Database_Town_Name, &ui_font_font1, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Database_Progress, &ui_font_font1, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_flag(ui_WorldMap, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    ...
    lv_obj_set_style_text_font(ui_Database_Dir_Path, &ui_font_font1, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Database_GPS_Position, &ui_font_font1, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Database_Output_File, &ui_font_font1, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_img_set_zoom(ui_Database_Flag, 192);
    ...
    lv_obj_add_event_cb(ui_WorldMap, ui_event_WorldMap, LV_EVENT_ALL, NULL);
