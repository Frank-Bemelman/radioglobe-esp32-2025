...
LV_IMG_DECLARE(ui_img_1936685767);    // assets/11d-70x60.png
...
LV_IMG_DECLARE(ui_img_1685429887);    // assets/bt-connected.png
...
LV_IMG_DECLARE(ui_img_1557815120);    // assets/hourhand-s4.png
LV_IMG_DECLARE(ui_img_minutes_png);    // assets/minutes.png
LV_IMG_DECLARE(ui_img_1132700052);    // assets/seconds-center.png
